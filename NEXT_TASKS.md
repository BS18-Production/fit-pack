...
- [x] **Cihazda dinlendi ve onaylandı (Samet, 2026-09-23):** yeni sesler ve
      düzelen aralık tamam. Beğenilmezse tık varyantı tek komutla değişir
      (`python3 tools/make_rest_sounds.py --tik marimba|cam`).
