# NEXT_TASKS arşivi — 2026-05 … 2026-07-12

> Kapanmış paketlerin kaydı. Açık kalan maddeleri NEXT_TASKS'teki
> "Arşivden gelen açık maddeler" bölümüne taşındı.
...
[docs/17-improvement-analysis.md](../17-improvement-analysis.md) analizinin
...
**[docs/16-settings-profile-ia.md](../16-settings-profile-ia.md)** →
...
Tasarım: [docs/14-localization.md](../14-localization.md). Yaklaşım: Flutter
...
Tasarım + uygulama aynı gün: **[docs/15-onboarding.md](../15-onboarding.md)**.
...
Tasarım notu: [docs/12-session-resilience.md](../12-session-resilience.md).
...
Tasarım + uygulama: [docs/10-historical-entry.md](../10-historical-entry.md). analyze 0 · test 65/65.
...
PRD: [docs/11-content-enrichment.md](../11-content-enrichment.md). analyze 0 · test 76/76. Tüm aşağıdakiler `main`'de + GitHub'da.
...
- [ ] **D-04** Antrenman V2 — Hevy/Strong genişleme. **PRD:** [docs/09-workout-v2.md](../09-workout-v2.md). Karar: tam geçiş (sadece rutinler), genel kitle, İngilizce hareketler.
...
Pilot geri bildirimi (P-1/2/3, [docs/07-nutrition-v2.md](../07-nutrition-v2.md)). **Commit'lendi + push'landı** (2026-05-20, `9ceb223`, dal `feat/sprint-0.1-migration`).
